## sicc_af
Structure Integrity Check and Correction for AlphaFold2 predicted proteins
...
Instructions:
Clone the project and run then sicc_af.py as a regular Python script with facultative --pdb-file argument being the path to the .pdb file.
...
```
```bash
$ python sicc_af.py --pdb-file /path/to/pdb/file
```
